...
export const adminAuthController = new Elysia({
    ...
    try {
        ...
        set.status = 500;
        return { message: "An internal error occurred while processing the admin creation." };
    }
}, {
    body: t.Object({
    ...
    try {
        ...
        const token = jwtLib.sign({ id: admin._id, email: admin.email }, "jgj71nQD!#!sd1211aAS(@JCACalsxa1725", { expiresIn: "1d" });
